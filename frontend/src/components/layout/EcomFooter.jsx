    ...
    <footer className="bg-slate-900 text-slate-400 py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              Chuyên cung cấp thịt sạch nhập khẩu quốc tế. Chất lượng hàng đầu,
              giao hàng tận nơi.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 list-none p-0">
              <li>
                <Link
                  to="/"
                  className="text-slate-400 hover:text-white no-underline text-sm transition-colors"
                >
                  Trang chủ
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-xs text-slate-500 uppercase font-bold tracking-wider m-0">
                  Hotline
                </p>
        ...
        <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p>© 2026 Deat Lemi Shop. All rights reserved.</p>
          <div className="flex gap-6">
            <Link
              to="#"
              className="text-slate-500 hover:text-white no-underline"
            >
              Privacy Policy
            </Link>
            <Link
