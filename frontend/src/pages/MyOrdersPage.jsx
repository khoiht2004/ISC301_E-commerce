      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        {orders.length === 0 ? (
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-12 text-center">
            ...
            <Link
              to="/products"
              className="inline-block mt-4 bg-primary-600 text-white font-bold py-2 px-6 rounded-xl hover:bg-primary-700 transition-colors"
            >
              Bắt đầu mua sắm
            </Link>
          </div>
              ...
              >
                ...
                <div className="p-4 md:px-6">
                  {order.orderItems.slice(0, 2).map((item, idx) => (
                    <div
                      key={item.id}
                      className={`flex gap-4 py-3 ${idx > 0 ? "border-t border-slate-50" : ""}`}
                    >
                      <img
                        src={
                ...
                <div className="bg-slate-50 border-t border-slate-100 p-4 md:px-6 flex items-center justify-between">
                  ...
                  <Link
                    to={`/orders/${order.id}`}
                    className="bg-white border-2 border-slate-200 text-slate-700 hover:border-primary-500 hover:text-primary-600 font-bold py-2 px-6 rounded-xl transition-colors text-sm"
                  >
                    Xem chi tiết
                  </Link>
                </div>
