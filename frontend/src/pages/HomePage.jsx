      ...
      >
        ...
        <div className="flex justify-center mb-8">
          <div className="w-48 h-48 rounded-full border-2 border-white/20 flex flex-col items-center justify-center relative bg-black/40 backdrop-blur-sm">
            <div className="text-white/60 text-xs font-bold tracking-[0.2em] mb-1">
              Deat Lemi
            </div>
  ...
  return (
    <section className="py-24 bg-white">
      <div className="container text-center">
        <h3 className="text-2xl font-bold mb-16 text-slate-800">
          Thịt sạch nhập khẩu quốc tế
        </h3>
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-500 text-xs mb-4 line-clamp-2 min-h-[32px]">
            {product.shortDescription ||
              "Thịt sạch nhập khẩu chất lượng cao, tươi ngon mỗi ngày."}
          </p>
          <div className="mb-4">
            {hasDiscount ? (
      ...
      <div className="container text-center">
        ...
        {loading ? (
          ...
          <div className="text-slate-500 italic mb-12">
            Đang cập nhật danh mục sản phẩm mới...
          </div>
        ) : (
...
const Partners = () => {
  const logos = [
    {
      name: "KFC",
      src: "https://upload.wikimedia.org/wikipedia/sco/thumb/b/bf/KFC_logo.svg/1280px-KFC_logo.svg.png",
    },
    {
      name: "LOTTE",
      src: "https://upload.wikimedia.org/wikipedia/vi/f/fd/Lotteria_logo.png?utm_source=vi.wikipedia.org&utm_campaign=index&utm_content=original",
    },
    {
      name: "Jollibee",
      src: "https://1000logos.net/wp-content/uploads/2019/03/jollibee-logo-png.png",
    },
  ];
  ...
  return (
    <section className="py-24 bg-slate-50 border-t border-slate-100">
      <div className="container text-center">
        <h3 className="text-xl font-bold mb-12 text-slate-800">
          Các Đối Tác Của Deat Lemi Shop
        </h3>
