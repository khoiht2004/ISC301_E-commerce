      ...
      <div className="flex items-center gap-4 mb-6 shrink-0">
        ...
        <div>
          <div className="text-xs text-slate-450 font-semibold uppercase tracking-wider flex items-center gap-1.5">
            <span>Sản phẩm</span>
            <span>/</span>
            <span className="text-primary-500">Thêm mới</span>
          </div>
          <h1 className="text-xl md:text-2xl font-black text-slate-100 mt-1">
            Thêm Sản Phẩm Mới
          </h1>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto pr-1">
        ...
        >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-6 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-805 focus:border-primary-600 rounded-xl px-4 py-3 text-xs focus:outline-none focus:ring-1 focus:ring-primary-600 transition-all text-slate-205 font-mono"
                  value={sku}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950 border border-slate-805 focus:border-primary-600 rounded-xl px-4 py-3 text-xs focus:outline-none focus:ring-1 focus:ring-primary-600 transition-all text-slate-200 resize-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950 border border-slate-805 focus:border-primary-600 rounded-xl px-4 py-3 text-xs focus:outline-none focus:ring-1 focus:ring-primary-600 transition-all text-slate-200 resize-y"
                  value={description}
            ...
            <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-6 space-y-5">
              <div className="flex items-center gap-2 border-b border-slate-800 pb-4 mb-2">
                <Upload className="text-primary-500" size={18} />
                <h3 className="font-extrabold text-sm text-slate-200 uppercase tracking-wide">
                  Hình ảnh sản phẩm
                </h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative group rounded-xl border border-dashed border-slate-800 hover:border-primary-800 bg-slate-950 flex flex-col items-center justify-center p-4 text-center cursor-pointer h-[150px] overflow-hidden transition-all">
                    {thumbnailPreview ? (
                      <>
                        <img
                        ...
                        <div className="absolute inset-0 bg-slate-950/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center transition-all">
                          <button
                            ...
                            className="p-2 bg-primary-600 hover:bg-primary-700 text-white rounded-full transition-all shadow-lg"
                          >
                            <X size={16} />
                          </button>
                        </div>
                      ...
                      <>
                        <Upload className="w-6 h-6 text-slate-600 mb-2 group-hover:text-primary-500 transition-colors" />
                ...
                <div>
                  ...
                  <div className="relative group rounded-xl border border-dashed border-slate-800 hover:border-primary-800 bg-slate-950 flex flex-col items-center justify-center p-4 text-center cursor-pointer h-[150px] overflow-hidden transition-all">
                    ...
                    <span className="text-[9px] text-slate-500 mt-1">
                      Giữ Ctrl hoặc chọn nhiều ảnh một lúc
                    </span>
                    <input
                      type="file"
                      multiple
              ...
              {imagePreviews.length > 0 && (
                <div className="pt-2">
                  <label className="block text-xs font-bold text-slate-500 mb-2.5 uppercase tracking-wider">
                    Hình ảnh album đã chọn ({imagePreviews.length})
                  </label>
                  <div className="flex flex-wrap gap-3">
                    {imagePreviews.map((img, idx) => (
                      <div
                        key={idx}
                        className="relative w-20 h-20 rounded-lg overflow-hidden border border-slate-800 bg-slate-950 group"
                      >
                        <img
                          src={img}
                          alt={`sub-${idx}`}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-6 space-y-5">
              ...
              <div className="flex items-center justify-between p-3 bg-slate-950/60 rounded-xl border border-slate-800/60">
                <span className="text-xs font-bold text-slate-350 select-none">
                  Công khai bán sản phẩm
                </span>
              ...
              <div className="pt-2 flex flex-col gap-3">
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3.5 bg-primary-800 hover:bg-primary-700 disabled:opacity-50 text-white text-xs font-extrabold rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-lg shadow-primary-950/45 border border-primary-750"
                >
                  <Save size={16} />
            ...
            <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-6 space-y-5">
              ...
              <div className="space-y-3">
                <label className="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wider">
                  Chọn tags cho sản phẩm
                </label>
                {tags.length === 0 ? (
                  <p className="text-xs text-slate-500 italic">
                    Chưa có tag nào trên hệ thống.
                  </p>
                ) : (
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-all ${
                            isSelected
                              ? "bg-primary-950/60 border-primary-650 text-primary-400 font-extrabold"
              ...
              <div className="bg-slate-950 rounded-xl border border-slate-850 p-3.5 space-y-2.5">
                <label className="block text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">
                  Tạo nhãn mới trực tiếp
                </label>
                <div className="flex gap-2">
                  <input
                    type="text"
                    placeholder="Tên tag (Ví dụ: Bò Mỹ)..."
                    className="flex-1 bg-slate-900 border border-slate-800 rounded-lg px-2.5 py-2 text-xs focus:outline-none focus:border-primary-600 text-slate-200"
                    value={newTagName}
                  ...
                  <button
                    ...
                    className="bg-primary-800 hover:bg-primary-750 disabled:opacity-50 text-white px-3 rounded-lg text-xs font-black transition-colors"
                  >
                    <Plus size={16} />
                  </button>
                </div>
