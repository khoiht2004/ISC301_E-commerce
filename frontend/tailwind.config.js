  ...
  theme: {
    extend: {
      colors: {
        ...
        cyan: scale("cyan", [400]),
        primary: scale("primary", [50, 100, 200, 400, 500, 600, 700, 800, 900, 950]),
        staff: {
          bg: solid("staff-bg"),
          surface: solid("staff-surface"),
          "surface-muted": solid("staff-surface-muted"),
          border: solid("staff-border"),
          text: solid("staff-text"),
          muted: solid("staff-muted"),
          primary: solid("staff-primary"),
          "primary-hover": solid("staff-primary-hover"),
          "primary-soft": solid("staff-primary-soft"),
        },
        dark: {
